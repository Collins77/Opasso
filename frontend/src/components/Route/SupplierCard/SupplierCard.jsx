    ...
    <>
        <Link to={`/shop/preview/${data?._id}`}>
          <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <img className="w-8 h-8 mb-2 rounded-full" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" src={`${data.avatar?.url}`}/>
              <a href="#">
              ...
              <div className="mb-2 flex mt-2 space-x-3 md:mt-6">
